...
const createButtonSizeStyles = (font: object, height: string) => [
  font,
  { height },
];
...
export const buttonStyle = recipe({
  ...
  variants: {
    ...
    color: {
      red: createButtonColorStyles(vars.colors.red1, vars.colors.white),
      gray: createButtonColorStyles(vars.colors.gray200, vars.colors.gray500),
